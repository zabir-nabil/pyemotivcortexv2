...
#############
'''
edited by zabiralnazi@yahoo.com
'''
...
class Cortex(object):
    ...
    def parse_client_id_file(self, client_id_file_path):
        ...
        ```
        '''
        self.client_id = "zVGvkZG66axd2MsjKg8azGB8dZtnC5nVJyWV3xJz"
        self.client_secret = "yJG5GhzRIuzSmhWmjpjJg6VbhZXypzTIyfNZFlGVxAZLEzVjwpa6NEYvbCydp0Kbo6e4uPbJc1Fr9YYNgNlTKukpAByTjjPeo4FsKN1RWA8ewfEidmyYTEqCwErWYH2T"
